...
#include "tf2_msgs/srv/frame_graph__rosidl_typesupport_fastrtps_c.h"
...
{
  return max_serialized_size_tf2_msgs__srv__FrameGraph_Request(
    full_bounded, 0);
}
...
#include "rosidl_generator_c/string.h"  // frame_yaml
#include "rosidl_generator_c/string_functions.h"  // frame_yaml
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->frame_yaml;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: frame_yaml
  {
    ...
    if (!ros_message->frame_yaml.data) {
      rosidl_generator_c__String__init(&ros_message->frame_yaml);
    }
...
{
  return max_serialized_size_tf2_msgs__srv__FrameGraph_Response(
    full_bounded, 0);
}
