...
bool driverless_msgs__msg__cone_with_covariance__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "driverless_msgs.msg._cone_with_covariance.ConeWithCovariance",
        full_classname_dest, 60) == 0);
  }
  driverless_msgs__msg__ConeWithCovariance * ros_message = _ros_message;
  {  // cone
    PyObject * field = PyObject_GetAttrString(_pymsg, "cone");
    if (!field) {
      return false;
    }
    if (!driverless_msgs__msg__cone__convert_from_py(field, &ros_message->cone)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of ConeWithCovariance */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("driverless_msgs.msg._cone_with_covariance");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ConeWithCovariance");
  ...
  {  // cone
    PyObject * field = NULL;
    field = driverless_msgs__msg__cone__convert_to_py(&ros_message->cone);
    if (!field) {
      return NULL;
    }
    {
