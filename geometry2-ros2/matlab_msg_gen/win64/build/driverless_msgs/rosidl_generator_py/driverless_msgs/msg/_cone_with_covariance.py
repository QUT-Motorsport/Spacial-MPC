...
class ConeWithCovariance(metaclass=Metaclass_ConeWithCovariance):
    ...
    _fields_and_field_types = {
        'cone': 'driverless_msgs/Cone',
        'covariance': 'double[4]',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['driverless_msgs', 'msg'], 'Cone'),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        from driverless_msgs.msg import Cone
        self.cone = kwargs.get('cone', Cone())
    ...
    def cone(self, value):
        if __debug__:
            from driverless_msgs.msg import Cone
            assert \
                isinstance(value, Cone), \
                "The 'cone' field must be a sub message of type 'Cone'"
        self._cone = value
