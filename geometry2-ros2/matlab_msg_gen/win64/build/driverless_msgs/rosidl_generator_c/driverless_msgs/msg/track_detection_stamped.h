...
#ifndef DRIVERLESS_MSGS__MSG__TRACK_DETECTION_STAMPED_H_
#define DRIVERLESS_MSGS__MSG__TRACK_DETECTION_STAMPED_H_
...
#endif  // DRIVERLESS_MSGS__MSG__TRACK_DETECTION_STAMPED_H_
