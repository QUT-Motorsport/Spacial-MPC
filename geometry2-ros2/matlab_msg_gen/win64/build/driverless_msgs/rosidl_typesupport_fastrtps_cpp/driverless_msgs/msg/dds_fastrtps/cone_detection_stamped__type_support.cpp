...
#include "driverless_msgs/msg/cone_detection_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const driverless_msgs::msg::ConeDetectionStamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  driverless_msgs::msg::ConeDetectionStamped & ros_message)
{
  // Member: header
  ...
  // Member: cones_with_cov
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    ros_message.cones_with_cov.resize(size);
    for (size_t i = 0; i < size; i++) {
      driverless_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.cones_with_cov[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: cones_with_cov
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        driverless_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.cones_with_cov[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_driverless_msgs
max_serialized_size_ConeDetectionStamped(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const driverless_msgs::msg::ConeDetectionStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<driverless_msgs::msg::ConeDetectionStamped *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ConeDetectionStamped__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const driverless_msgs::msg::ConeDetectionStamped *>(
...
{
  return max_serialized_size_ConeDetectionStamped(full_bounded, 0);
}

static message_type_support_callbacks_t _ConeDetectionStamped__callbacks = {
  "driverless_msgs::msg",
...
static rosidl_message_type_support_t _ConeDetectionStamped__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ConeDetectionStamped__callbacks,
...
{
  return &driverless_msgs::msg::typesupport_fastrtps_cpp::_ConeDetectionStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, driverless_msgs, msg, ConeDetectionStamped)() {
  return &driverless_msgs::msg::typesupport_fastrtps_cpp::_ConeDetectionStamped__handle;
}
