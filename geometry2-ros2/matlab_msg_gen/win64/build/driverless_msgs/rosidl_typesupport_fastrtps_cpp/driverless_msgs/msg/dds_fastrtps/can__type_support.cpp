...
#include "driverless_msgs/msg/can__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const driverless_msgs::msg::Can & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  driverless_msgs::msg::Can & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
{
  auto typed_message =
    static_cast<const driverless_msgs::msg::Can *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<driverless_msgs::msg::Can *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Can(full_bounded, 0);
}
...
{
  return &driverless_msgs::msg::typesupport_fastrtps_cpp::_Can__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, driverless_msgs, msg, Can)() {
  return &driverless_msgs::msg::typesupport_fastrtps_cpp::_Can__handle;
}
