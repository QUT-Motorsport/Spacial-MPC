...
#include "driverless_msgs/msg/path_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const driverless_msgs::msg::PathPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  driverless_msgs::msg::PathPoint & ros_message)
{
  // Member: location
...
{
  auto typed_message =
    static_cast<const driverless_msgs::msg::PathPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<driverless_msgs::msg::PathPoint *>(
    untyped_ros_message);
...
{
  return &driverless_msgs::msg::typesupport_fastrtps_cpp::_PathPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, driverless_msgs, msg, PathPoint)() {
  return &driverless_msgs::msg::typesupport_fastrtps_cpp::_PathPoint__handle;
}
