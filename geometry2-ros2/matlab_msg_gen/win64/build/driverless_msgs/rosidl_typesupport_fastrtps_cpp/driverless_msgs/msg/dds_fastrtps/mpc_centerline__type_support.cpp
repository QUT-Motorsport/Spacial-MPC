...
#include "driverless_msgs/msg/mpc_centerline__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const driverless_msgs::msg::MPCPathPoint &,
...
cdr_serialize(
  const driverless_msgs::msg::MPCCenterline & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  driverless_msgs::msg::MPCCenterline & ros_message)
{
  // Member: path
  {
    uint32_t cdrSize;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_driverless_msgs
max_serialized_size_MPCCenterline(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // Member: path
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        driverless_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_MPCPathPoint(
...
{
  auto typed_message =
    static_cast<const driverless_msgs::msg::MPCCenterline *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<driverless_msgs::msg::MPCCenterline *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MPCCenterline__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const driverless_msgs::msg::MPCCenterline *>(
...
{
  return max_serialized_size_MPCCenterline(full_bounded, 0);
}

static message_type_support_callbacks_t _MPCCenterline__callbacks = {
  "driverless_msgs::msg",
  "MPCCenterline",
...
static rosidl_message_type_support_t _MPCCenterline__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MPCCenterline__callbacks,
...
{
  return &driverless_msgs::msg::typesupport_fastrtps_cpp::_MPCCenterline__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, driverless_msgs, msg, MPCCenterline)() {
  return &driverless_msgs::msg::typesupport_fastrtps_cpp::_MPCCenterline__handle;
}
