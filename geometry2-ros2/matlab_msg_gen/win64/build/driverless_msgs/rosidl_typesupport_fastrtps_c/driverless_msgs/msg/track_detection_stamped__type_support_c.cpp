...
#include "driverless_msgs/msg/track_detection_stamped__rosidl_typesupport_fastrtps_c.h"
...
#include "driverless_msgs/msg/cone_with_covariance__functions.h"  // cones
...
using _TrackDetectionStamped__ros_msg_type = driverless_msgs__msg__TrackDetectionStamped;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrackDetectionStamped__ros_msg_type * ros_message = static_cast<const _TrackDetectionStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TrackDetectionStamped__ros_msg_type * ros_message = static_cast<_TrackDetectionStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: cones
  {
    ...
    if (ros_message->cones.data) {
      driverless_msgs__msg__ConeWithCovariance__Sequence__fini(&ros_message->cones);
    }
...
size_t get_serialized_size_driverless_msgs__msg__TrackDetectionStamped(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TrackDetectionStamped__ros_msg_type * ros_message = static_cast<const _TrackDetectionStamped__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TrackDetectionStamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_driverless_msgs__msg__TrackDetectionStamped(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_driverless_msgs
size_t max_serialized_size_driverless_msgs__msg__TrackDetectionStamped(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_driverless_msgs__msg__TrackDetectionStamped(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_TrackDetectionStamped = {
  "driverless_msgs::msg",
...
static rosidl_message_type_support_t _TrackDetectionStamped__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrackDetectionStamped,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, driverless_msgs, msg, TrackDetectionStamped)() {
  return &_TrackDetectionStamped__type_support;
}
