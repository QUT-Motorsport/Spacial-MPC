...
static const _AckermannDrive_type_support_symbol_names_t _AckermannDrive_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ackermann_msgs, msg, AckermannDrive)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ackermann_msgs, msg, AckermannDrive)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ackermann_msgs, msg, AckermannDrive)() {
  return &::ackermann_msgs::msg::rosidl_typesupport_c::AckermannDrive_message_type_support_handle;
}
