...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PathPoint_message_member_array[2] = {
  {
    ...
    offsetof(driverless_msgs::msg::PathPoint, location),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(driverless_msgs::msg::PathPoint, turn_intensity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PathPoint_message_members = {
  ...
  2,  // number of fields
  sizeof(driverless_msgs::msg::PathPoint),
...
{
  return &::driverless_msgs::msg::rosidl_typesupport_introspection_cpp::PathPoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, driverless_msgs, msg, PathPoint)() {
  return &::driverless_msgs::msg::rosidl_typesupport_introspection_cpp::PathPoint_message_type_support_handle;
}
