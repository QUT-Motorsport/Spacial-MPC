...
bool driverless_msgs__msg__cone__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool driverless_msgs__msg__cone_detection_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "driverless_msgs.msg._cone_detection_stamped.ConeDetectionStamped",
        full_classname_dest, 64) == 0);
  }
  driverless_msgs__msg__ConeDetectionStamped * ros_message = _ros_message;
  {  // header
  ...
  {  // cones
    ...
    if (!driverless_msgs__msg__Cone__Sequence__init(&(ros_message->cones), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create driverless_msgs__msg__Cone__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    driverless_msgs__msg__Cone * dest = ros_message->cones.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!driverless_msgs__msg__cone__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // cones_with_cov
    PyObject * field = PyObject_GetAttrString(_pymsg, "cones_with_cov");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'cones_with_cov'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    driverless_msgs__msg__ConeWithCovariance * dest = ros_message->cones_with_cov.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
{
  /* NOTE(esteve): Call constructor of ConeDetectionStamped */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("driverless_msgs.msg._cone_detection_stamped");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ConeDetectionStamped");
  ...
  {  // cones
    ...
    driverless_msgs__msg__Cone * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->cones.data[i]);
      PyObject * pyitem = driverless_msgs__msg__cone__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // cones_with_cov
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->cones_with_cov.data[i]);
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "cones_with_cov", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
