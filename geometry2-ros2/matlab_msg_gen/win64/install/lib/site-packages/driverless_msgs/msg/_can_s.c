...
bool driverless_msgs__msg__can__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "driverless_msgs.msg._can.Can",
        full_classname_dest, 28) == 0);
  }
  driverless_msgs__msg__Can * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of Can */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("driverless_msgs.msg._can");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Can");
