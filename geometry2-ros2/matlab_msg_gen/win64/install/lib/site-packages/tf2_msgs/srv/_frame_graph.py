...
class FrameGraph_Request(metaclass=Metaclass_FrameGraph_Request):
    ...
    __slots__ = [
        '_structure_needs_at_least_one_member',
    ]
    ...
    def __init__(self, **kwargs):
        ...
        self.structure_needs_at_least_one_member = kwargs.get('structure_needs_at_least_one_member', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.structure_needs_at_least_one_member != other.structure_needs_at_least_one_member:
            return False
        return True
    ...
    @property
    def structure_needs_at_least_one_member(self):
        """Message field 'structure_needs_at_least_one_member'."""
        return self._structure_needs_at_least_one_member

    @structure_needs_at_least_one_member.setter
    def structure_needs_at_least_one_member(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'structure_needs_at_least_one_member' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'structure_needs_at_least_one_member' field must be an unsigned integer in [0, 255]"
        self._structure_needs_at_least_one_member = value
